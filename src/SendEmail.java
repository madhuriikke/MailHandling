 ...
 * 
 * 
 * public static void main(String [] args){ String to =
 * "sonoojaiswal1988@gmail.com";//change accordingly String from =
 * "sonoojaiswal1987@gmail.com";//change accordingly String host =
